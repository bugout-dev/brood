...
def upgrade():
    ...
    op.create_unique_constraint(op.f('uq_resource_holder_permissions_user_id'), 'resource_holder_permissions', ['user_id', 'group_id', 'resource_id', 'permission'])
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    return
    op.drop_constraint(op.f('uq_resource_holder_permissions_user_id'), 'resource_holder_permissions', type_='unique')
